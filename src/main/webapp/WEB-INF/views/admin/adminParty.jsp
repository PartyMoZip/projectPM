...
<div class="all-wrap">
  ...
  <nav class="nav nav-pills flex-column flex-sm-row">
    <a class="flex-sm-fill text-sm-center nav-link active" href="/admin/adminParty">파티관리</a>
    ...
    <a class="flex-sm-fill text-sm-center nav-link" href="/admin/adminBlackParty">블랙파티리스트 관리</a>
  </nav>
        ...
        <th scope="col">
          <div class="checkbox-group">
            <div class="checkbox-groupParty">
              <input type="checkbox" id="check-allParty" name="check-allParty" class="bigCheck">
            </div>
          </div>
        </th>
        <!-- 파티관리 체크박스 전체선택 끝 -->
