...
<div class="all-wrap">
  ...
  <nav class="nav nav-pills flex-column flex-sm-row">
    ...
    <a class="flex-sm-fill text-sm-center nav-link active" href="/admin/adminPartyBreak">파티해체 승인 요청</a>
        ...
        <th scope="col">
          <div class="checkbox-group">
            <div class="checkbox-groupPartyBreak">
              <input type="checkbox" id="check-allPartyBreak" name="check-allPartyBreak" class="bigCheck">
            </div>
          </div>
          <!-- 파티해체요청 체크박스 전체선택 끝 -->
        </th>
