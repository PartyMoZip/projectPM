...
<div class="all-wrap">
  ...
  <nav class="nav nav-pills flex-column flex-sm-row">
    ...
    <a class="flex-sm-fill text-sm-center nav-link active" href="/admin/adminBlackMember">블랙회원리스트 관리</a>
        ...
        <th scope="col">
          <div class="checkbox-group">
            <div class="checkbox-groupBlackMember">
              <input type="checkbox" id="check-allBlackMember" name="check-allBlackMember" class="bigCheck">
            </div>
          </div>
          <!-- 블랙회원리스트 체크박스 전체선택 끝 -->
        </th>
