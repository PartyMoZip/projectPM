        ...
        <div class="container-lg d-flex justify-content-center">
          ...
          >
            <div
              ...
              "
            >
              <span class="align-self-baseline label-partyLoc">활동지역</span>
              <select
            ...
            >
              ...
              <input
                type="text"
                class="form-control input-newParty mt-2"
                name="newParty"
                value=""
              />
            </div>
            ...
            <div class="container-categoryBtn flex-wrap">
              <input
                ...
                autocomplete="off"
              />
              <label class="btn btn-outline-secondary" for="btn-check-soccer"
                >축구</label
              ><br />
              ...
              <input
                ...
                autocomplete="off"
              />
              <label class="btn btn-outline-secondary" for="btn-check-baseball"
                >야구</label
              ><br />
              ...
              <input
                ...
                autocomplete="off"
              />
              <label class="btn btn-outline-secondary" for="btn-check-mountain"
                >등산</label
              ><br />
              ...
              <input
                ...
                autocomplete="off"
              />
              <label class="btn btn-outline-secondary" for="btn-check-billiards"
                >당구</label
              ><br />
              ...
              <input
                ...
                autocomplete="off"
              />
              <label class="btn btn-outline-secondary" for="btn-check-boardGame"
                >보드게임</label
              ><br />
              ...
              <input
                ...
                autocomplete="off"
              />
              <label class="btn btn-outline-secondary" for="btn-check-cooking"
                >요리</label
              ><br />
            </div>
          </div>
