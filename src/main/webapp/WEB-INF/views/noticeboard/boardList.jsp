...
<main>
    <div class="all-wrap">
        <nav id="noticebar" class="nav nav-pills flex-column flex-sm-row">
            <a class="flex-sm-fill text-sm-center nav-link active" href="#">공지게시판</a>
        </nav>
        <!-- 자유게시판 테이블 시작 -->
                    ...
                    <th scope="col">
                        <div class="checkbox-group">
                            <div class="checkbox-groupParty">
                                <input type="checkbox" id="check-allNoticeBoard" name="check-allNoticeBoard"
                                       class="bigCheck">
                            </div>
                        </div>
                    </th>
