    ...
    <div class="container-sm">
                ...
                <c:choose>
                    <c:when test="${not empty list}">
                        <c:forEach items="${list}" var="list">
                            <tr>
                                <td><c:out value="${list.QRefer}"/></td>
                                <td>
                                    <a href="/qnaboard/showQnaDetail?qrefer=${list.QRefer}&currPage=${pageMaker.cri.currPage}&amount=${pageMaker.cri.amount}&pagesPerPage=${pageMaker.cri.pagesPerPage}">${list.QSubject}</a>
                                </td>
        ...
        <div class="d-grid gap-2 d-md-block">
            <button type="button" class="btn btn-primary btn-sm"
                    onclick="location.href='/qnaboard/writeQnaBoardView'">
