			...
			<div class="container-sm">
							...
							<c:choose>
								<c:when test="${not empty list}">
									<c:forEach items="${list}" var="list">
										<tr>
											<td><c:out value="${list.FRefer}" /></td>
											<td><a
												href="/freeboard/showFreeDetail?frefer=${list.FRefer}&currPage=${pageMaker.cri.currPage}&amount=${pageMaker.cri.amount}&pagesPerPage=${pageMaker.cri.pagesPerPage}">${list.FSubject}</a>
											</td>
				...
				<div class="d-grid gap-2 d-md-block">
					<button type="button" class="btn btn-primary btn-sm"
						onclick="location.href='/freeboard/writeFreeBoardView'">
						<i class="fas fa-list-ul"></i> <span>글쓰기</span>
					</button>
				</div>
				<div id="pagination">
				...
				<!-- 검색창 -->
				<!-- 검색창 -->
				<form action="/freeboard/getFreeBoardList" method="get">
