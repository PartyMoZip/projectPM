											...
											<div class="d-flex justify-content-between align-items-center">
												<div class="btn-group">
													<button type="button" class="btn btn-sm btn-outline-secondary"
														onClick="location.href='/partyphoto/detail?prefer=${list.prefer}&partyCode=${list.partycode}&currPage=${pageMaker.cri.currPage}&searchWord=${ldto.searchWord}&option=${ldto.option}';">View</button>
												</div>
