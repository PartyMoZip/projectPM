...
public interface FreeBoardService {
    ...
    // 자유 게시판 목록 - 페이징 처리
    public abstract  List<FreeBoardListVO> getListPerPage(Criteria cri);
    ...
    // 자유 게시판 검색
    public abstract List<FreeBoardSearchVO> search(String searchOption, String keyword, Criteria cri);
